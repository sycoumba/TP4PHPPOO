...
// function addClient_salarie($adresse, $telephone, $email, $nom, $prenom, $profession, $salaire_actuel,
//  $nom_entreprise,$adresse_entreprise, $identifiant_entreprise, $numero_CNI, $id_client)
// {
//     $conn = getConnection();
